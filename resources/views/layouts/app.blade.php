                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                      @auth
                       ...
                       <li class="nav-item">
                          <a class="nav-link" href="{{ url('my/protfilio') }}">protfilio</a>
                       </li>
                       <li class="nav-item">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('login_Register') }}">{{ __('Register') }}</a>
                            </li>
                            @auth
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                   <a class="dropdown-item" href="{{ url('user/profile/edit') }}">profile edit</a>
